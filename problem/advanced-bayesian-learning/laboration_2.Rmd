...
tibble(nu0 = c(1, 10, 100)) %>%
  mutate(data = map(nu0, ~ nu_sample(l = 10000, nu = nu_prior(.x)))) %>%
  unnest(data) %>%
...
tibble(nu0 = c(1, 10, 100)) %>%
  mutate(data = map(nu0, ~ nu_sample(l = 10000,
